...
type WalletServiceClient interface {
	...
	UpdateBalance(ctx context.Context, in *WalletUpdateRequest, opts ...grpc.CallOption) (*WalletUpdateResponse, error)
}
...
func (c *walletServiceClient) UpdateBalance(ctx context.Context, in *WalletUpdateRequest, opts ...grpc.CallOption) (*WalletUpdateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WalletUpdateResponse)
...
type WalletServiceServer interface {
	...
	UpdateBalance(context.Context, *WalletUpdateRequest) (*WalletUpdateResponse, error)
...
func (UnimplementedWalletServiceServer) UpdateBalance(context.Context, *WalletUpdateRequest) (*WalletUpdateResponse, error) {
...
func _WalletService_UpdateBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServiceServer).UpdateBalance(ctx, req.(*WalletUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
